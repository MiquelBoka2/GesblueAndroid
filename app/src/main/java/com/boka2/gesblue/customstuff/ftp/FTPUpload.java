                    ...
                    for (File file : files) {
                        if  (file.isDirectory() == false)  {
                            ...
                            if(fotoParts.length>1) {
                                ...
                                String data = "storage/emulated/0/Boka2/upload/" + foto;
                                ...
                                if (result) {
                                    ...
                                    File from = new File("storage/emulated/0/Boka2/upload/" + foto);
                                    File to = new File("storage/emulated/0/Boka2/upload/error/" + foto);
                                    from.renameTo(to);
                                }
                                ...
                                if (con.login("gesblue", "Sjos0o6n")) {
                                    ...
                                    if (result) {
                                        ...
                                        File direct2 = new File("storage/emulated/0/Boka2/upload/error");
                                        if (!direct2.exists()) {
                                            File wallpaperDirectory2 = new File("storage/emulated/0/Boka2/upload/error");
