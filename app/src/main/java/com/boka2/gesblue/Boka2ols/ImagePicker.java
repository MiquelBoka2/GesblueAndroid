...
public class ImagePicker {
    ...
    public static Intent getPickImageIntent(Context context) {
        ...
        if(Build.VERSION.SDK_INT>= Build.VERSION_CODES.Q){//IF SDK >= API 29 USE DIFERENT METOTHD
            ...
            /*
            try {
                File photoFile= BK_Tools.Companion.createImageFileInAppDir(context);
                Uri photoURI = FileProvider.getUriForFile(context, "com.winnr.app.provider",photoFile);
            ...
            Uri photoURI = FileProvider.getUriForFile(context, "com.winnr.app.provider", getTempFile(context));
            takePhotoIntent.putExtra(MediaStore.EXTRA_OUTPUT, photoURI);
    ...
    public static Bitmap getImageFromResult(Context context, int resultCode,Intent imageReturnedIntent) {
        ...
        if (resultCode == Activity.RESULT_OK) {
            ...
            if (isCamera) {     /** CAMERA **/
                selectedImage = FileProvider.getUriForFile(context,"com.winnr.app.provider",imageFile);
            } else {            /** ALBUM **/
    ...
    public static File getTempFile(Context context) {
        ...
        File root =new File(dir2, "/Winnr");
        if(!root.exists()) {
            root.mkdirs();
        }

        File imageFile = new File(root, TEMP_IMAGE_NAME);
    ...
    public static Bitmap rotateImage(Context context,Bitmap bitmap_to_rotate,File original){
        ...
        return ImagePicker.rotate(bitmap_to_rotate,rotate);
